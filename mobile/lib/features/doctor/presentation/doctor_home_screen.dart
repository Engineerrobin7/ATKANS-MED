...
class DoctorHomeScreen extends ConsumerWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildMessageCard('John Doe', 'When should I take the medication?', '10 min ago'),
                  _buildMessageCard('Jane Smith', 'Lab results uploaded', '1 hour ago'),
                  _buildMessageCard('Bob Wilson', 'Can we reschedule?', '3 hours ago'),
                ],
              ),
            ),
          ],
  ...
  Widget _buildMessageCard(String patient, String message, String time) {
    return GlassCard(
      margin: const EdgeInsets.only(bottom: 12),
      padding: const EdgeInsets.all(16),
      child: Row(
